package com.job.management.service.quartz.service;
...
public class JobServiceImpl implements JobService {
    ...
    public boolean scheduleOneTimeJob(String jobName, Class<? extends QuartzJobBean> jobClass, Date date) {
        ...
        String triggerKey = jobName, groupKey = "SampleGroup";
        ...
        try {
            ...
            log.info("Job with key :" + jobKey + " and group :" + groupKey + " scheduled successfully for date :" + dt);
            return true;
